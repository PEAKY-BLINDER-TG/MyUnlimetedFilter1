...
__help__ = """
 ...
 - */my_info*: get information about a user

 - */group_inf_del*: deletes your information from the bot's database. Private chats only.
...
INFO_HANDLER = DisableAbleCommandHandler("my_info", info, pass_args=True)

ECHO_HANDLER = CommandHandler("echo", echo, filters=Filters.user(OWNER_ID))
MD_HELP_HANDLER = CommandHandler("mark", markdown_help, filters=Filters.private)

STATS_HANDLER = CommandHandler("stats", stats, filters=CustomFilters.sudo_filter)
GDPR_HANDLER = CommandHandler("group_inf_del", gdpr, filters=Filters.private)
