...
if ENV:
    ...
    SUPPORT_CHAT = os.environ.get('DONATION_LINK', 'MyAwesomeSupportGroupGoesHere')
    WORKERS = int(os.environ.get('WORKERS', 8))
    BAN_STICKER = os.environ.get('BAN_STICKER', 'CAADAgADOwADPPEcAXkko5EB3YGYAg')
    ALLOW_EXCL = os.environ.get('ALLOW_EXCL', False)
    ABOUT_IMG = os.environ.get('ABOUT_IMG', 'https://telegra.ph/file/0210b2877969aaecee523.jpg')
    DANATE_PHOTO = os.environ.get('DONATE', 'https://telegra.ph/file/0210b2877969aaecee523.jpg')
